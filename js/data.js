...
window.RESUME = {
  ...
  /* GymChess: описание, комикс (4 кадра: реплика + подпись) и инфографика. Рисунки кадров — в main.js.
     ladders.steps — высоты столбиков мини-графика; potential — идеи развития, в коде их пока нет */
  gymchess: {
    kicker: 'Свой продукт · Android · Kotlin · Jetpack Compose',
    tagline: 'Лесенка подтягиваний с шахматными часами',
    lead: 'Перспективное игровое приложение с социально-спортивной механикой. Тренировка превращается в пошаговую дуэль: 2–4 человека, один телефон, у каждого свои часы. Часы идут только в твой ход, поэтому отдых — это ресурс, за который платишь временем.',
    repo: 'https://github.com/Chebarbado/GymChess',
    repoLabel: 'Код на GitHub',
    comic: [
      { bubble: 'Лесенка до 10, по 10 минут. Погнали!', caption: 'Двое у турника и один телефон. У каждого — свои шахматные часы.' },
      { bubble: 'Твои часы тикают!', caption: 'Твой ход — идёт твоё время. Сделал подход — передал ход. Пока работает соперник, отдыхаешь бесплатно.' },
      { bubble: 'Отдохнуть бы… но это стоит времени', caption: 'Лесенка растёт: 1, 2, 3… Каждая секунда отдыха в свой ход съедает запас. Это и есть тактика.' },
      { bubble: 'Флаг упал!', caption: 'Время вышло — выбываешь. Побеждает тот, кто закрыл лесенку и сберёг больше времени.' }
    ],
    /* Как засчитываются подтягивания. now — как это работает в приложении сегодня (по коду).
       next — КОНЦЕПТ автоподсчёта по камере: в репозитории его нет, на сайте он так и подписан */
    counting: {
      title: 'Как засчитываются подтягивания',
      now: {
        badge: 'Сейчас',
        title: 'Судья — соперник',
        text: 'Телефон лежит рядом. Сделал подход — нажал «Передать ход», и пошли часы соперника. Чистоту повторов контролируют те, кто стоит рядом: это и есть социальная механика.',
        button: 'Передать ход'
      },
      next: {
        badge: 'Концепт · в коде пока нет',
        title: 'Автоподсчёт по камере',
        text: 'Телефон на штативе видит игрока, модель оценки позы отдаёт ключевые точки: запястья, локти, плечи, подбородок. Повтор засчитывается, только когда подбородок поднялся выше перекладины, а затем руки полностью выпрямились. Недотянул — не считается.',
        labels: {
          bar: 'линия перекладины', angle: 'угол в локте', up: 'ВВЕРХУ', down: 'ВНИЗУ', reps: 'повторы',
          signal: 'высота подбородка', high: 'порог: выше перекладины', low: 'порог: руки прямые',
          ok: '+1 засчитано', miss: 'не засчитано', rule: 'ВНИЗУ → ВВЕРХУ → ВНИЗУ = +1'
        }
      }
    },
    facts: [
      { text: '2–4', label: 'игрока на одном устройстве' },
      { value: 4, label: 'типа лесенки' },
      { value: 2, label: 'упражнения: подтягивания и брусья' },
      { value: 50, label: 'юнит-тестов на движок и экраны' }
    ],
    laddersTitle: 'Типы лесенки',
    ladders: [
      { name: 'Быстрая', pattern: '1-2-3…', steps: [1, 2, 3, 4, 5, 6, 7], note: 'общая: ступени по очереди' },
      { name: 'Медленная', pattern: '1-1-2-2…', steps: [1, 1, 2, 2, 3, 3, 4], note: 'у каждого своя' },
      { name: 'Только вверх', pattern: '1…N', steps: [1, 2, 3, 4, 5, 6, 7], note: 'у каждого своя' },
      { name: 'Вверх-вниз', pattern: '1…N…1', steps: [1, 2, 3, 4, 3, 2, 1], note: 'у каждого своя' }
    ],
    flowTitle: 'Путь игрока',
    flow: ['Настройка', 'Игроки', 'Игра', 'Результаты', 'История'],
    stackTitle: 'Под капотом',
    stack: ['Kotlin', 'Jetpack Compose', 'Material 3', 'Navigation Compose', 'DataStore', 'MVVM', 'Чистый domain-слой', 'Coroutines', 'Звук и вибрация по таймауту', 'История: 50 игр'],
    potentialTitle: 'Куда расти',
    potential: ['Онлайн-дуэли и рейтинг', 'Челленджи для друзей и команд', 'Новые упражнения', 'Статистика прогресса']
  },
