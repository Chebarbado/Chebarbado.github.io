...
window.RESUME = {
  ...
  cgi: {
    ...
    steps: [
      ...
      { title: 'Рендер', text: 'Photo-real рендер в Cycles. Секвенции PNG и EXR — 5 887 кадров, квадратные и широкоформатные, до 3K.', tools: ['Cycles', 'PNG / EXR', '2K — 3K'] },
  ...
  /* «Айсберг»: то, что не помещается в резюме. Цифры — из реального архива проектов.
     Здание = проект, глубина под водой = объём в ГБ. Названия заказчиков и моделей обезличены. */
  iceberg: {
    kicker: 'Vol. 510 GB · № 14 053 · Late City Edition',
    ...
    stops: [
      ...
      { line: '7', color: '#b933ad', value: '5 887', label: 'кадров рендера: секвенции PNG и EXR, до 3K' },
      ...
      { line: 'S', color: '#ff6a33', value: '510 ГБ', label: '14 053 файла · 2022–2026. И это только верхушка.' }
    ],
